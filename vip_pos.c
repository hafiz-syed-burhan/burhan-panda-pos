...
┌───────[syed-burhan@DevOps]-[~]
└─$ cd project2/
┌───────[syed-burhan@DevOps]-[project2]
└─$ ls
1                claude1   Dockerfile  original1  receipt_BK1352.txt  vip_pos
burhanpanda4     claude2   images      original2  receipt_BK6733.txt  vip_pos.c
burhan_panda.db  claudeV3  Makefile    pos        try1
┌───────[syed-burhan@DevOps]-[project2]
└─$ nano joot
┌───────[syed-burhan@DevOps]-[project2]
└─$ sed -i 's/Burhan Panda Pos/PANDA POS/g' jhoot
sed: can't read jhoot: No such file or directory
┌───────[syed-burhan@DevOps]-[project2]
└─$ ls
1                claude1   Dockerfile  Makefile   pos                 try1
burhanpanda4     claude2   images      original1  receipt_BK1352.txt  vip_pos
burhan_panda.db  claudeV3  joot        original2  receipt_BK6733.txt  vip_pos.c
┌───────[syed-burhan@DevOps]-[project2]
└─$ cat joot
// ============================================================
//   BURHAN PANDA FOOD MANAGEMENT SYSTEM  v2.0 - 
